...
/**
 * http://username2.iteye.com/blog/2158925
 * @author hailin
 *
 */
public class HDFSTest {
	public static void main(String[] args) throws Exception {
		 uploadLocalFile2HDFS("D:/tmp/test-spark-data10.txt","/tmp/test-spark-data1.txt");//E盘下文件传到hdfs上
	...
	private static Configuration getConf() {
		...
		conf.set("fs.default.name", "hdfs://kvm-5-118:9000");
		return conf;
	}
